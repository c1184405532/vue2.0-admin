<template>
  <div class="header_bar_box" :style="headerStyle()">
    <div class="left" @click="toggleClick">
      <img class="logo" v-if="isMobile" src="" alt="" />
      <a-icon
        class="menu"
        :style="{ fontSize: '20px' }"
    ...
    <div class="right">
      <a-config-provider>
        ...
        <div class="message">
          <a-dropdown
            :trigger="['click']"
            overlayClassName="header_message_box"
          >
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <div class="item" @click="removeList(index)">
                        {{ value.Ltext }}
                      </div>
  ...
  */
  ...
  watch: {
    tabsActive(newValue, oldValue) {
      ...
      if (
        this.tabsData[oldValue].data.length < 1 &&
        this.tabsData[newValue].data.length < 1
      ) {
  ...
  methods: {
    ...
    headerStyle() {
      if (this.isFixed) {
        const width = this.isMobile ? 0 : this.collapsed ? 80 : 180;
        return {
          position: "fixed",
          zIndex: "100",
